...

{
  ...
  programs.btop = {
    ...
    settings = {
      ...
      # color_theme = "/home/rehan/.config/btop/themes/catppuccin_mocha.theme";
      ...
      #* "True" shows bitrates in base 10 (Kbps, Mbps).
      #* "False" shows bitrates in binary sizes (Kibps, Mibps, etc.).
